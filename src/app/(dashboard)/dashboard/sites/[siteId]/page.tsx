  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="p-6 space-y-6">
        ...
        {userRole !== 'user' && site.status === 'active' && site.settings?.onboarding_completed && !regenerating && !isActivelyRegenerating && (
          <Card className="border-[#00ef99]/30 bg-[#00ef99]/5">
            <CardContent className="pt-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {/* Scheduling — visible to all roles */}
            ...
            <CardContent>
              ...
              <Button variant="outline" size="sm" asChild>
                <Link href={`/dashboard/sites/${siteId}/scheduling`}>
                  {userRole === 'user' ? 'View My Schedule' : 'View Calendar'}
                </Link>
              </Button>
            </CardContent>
          </Card>

          {/* Job Snaps — visible to all roles */}
          <Card className="hover:border-[#00ef99]/20 transition-colors">
            <CardHeader>
              <div className="flex items-center gap-2">
          ...
          {/* Connect Your Website (Job Snaps API + Webhooks) */}
          <Card className="hover:border-[#00ef99]/20 transition-colors">
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="font-semibold">Connect Your Website</h3>
                  <p className="text-sm text-gray-500">API keys + webhooks for external sites</p>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-600 mb-4">
                Display Job Snaps on Next.js, WordPress, or any external site
              </p>
              <Button variant="outline" size="sm" asChild>
                <Link href={`/dashboard/sites/${siteId}/settings/integrations`}>
                  Manage Integrations
                </Link>
              </Button>
            </CardContent>
