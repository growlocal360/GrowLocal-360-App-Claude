...
export function NeighborhoodPageSingleLocation({ data, siteSlug, categories, recentWorkItems }: NeighborhoodPageSingleLocationProps) {
  ...
  const breadcrumbSchema = buildBreadcrumbSchema([
    { name: 'Home', url: siteUrl + paths.locationHome() },
    { name: 'Neighborhoods', url: siteUrl + paths.neighborhoodsIndex() },
    { name: neighborhood.name, url: siteUrl + paths.neighborhoodPage(neighborhood.slug) },
  ]);
          ...
          <div className="mx-auto max-w-7xl px-4">
            <div className="grid gap-12 lg:grid-cols-3">
              ...
              <div className="space-y-6">
                ...
                {/* Other Neighborhoods - Single location URL structure */}
